...
--(SELECT TOP 1 EmployeeID FROM Employees ORDER BY EmployeeID DESC)  Se coge el último EmployeeID
...
--CONSULTAS
--Vista que nos devuelva los nombres de todos los clientes que nos han comprado algún  producto de la categoría "Dairy Products”, 
--así como las fechas de la primera y la última compra. 
--Además de todo lo anterior, queremos saber también el nombre del distribuidor con el que hicimos el envío. Si hay varios 
